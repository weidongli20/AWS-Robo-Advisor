    ...
    if age is not None:
        ...
        if age <= 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "You should be greater than zero and less than 65 to use this service, "
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        # the elicitSlot dialog action is used to 
    ...
    if risk_level == "none":
        ...
        initial_recommendation = "to think it again" 
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            based on the risk level you defined, my recommendation is to choose an     
